...
export const USER_ROLE = [{ value: 'ADMIN', label: 'ADMIN' }];
...
export const ALLOWED_EXCHANGE = [
  { value: '651be5430c5c81a75c39ee32', label: '651be5430c5c81a75c39ee32' },
];
...
export const _userList = [...Array(30)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
  ...
  userId: _mock.userIDs(index),
  exchange: _mock.exchange(index),
  // phoneNumber: _mock.phoneNumber(index),
  status:
